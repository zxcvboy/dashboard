	...
	return BaseController.extend("Managment.Dashboard.controller.Monitor", {
		...
		onInit: function () {
			this.getView().setModel(new sap.ui.model.json.JSONModel({
				...
				"output": 8290,
				"HTML":'<p style="color:#00FFFE; font-size:18px;">Kiln temperature is rising continuously. NOx emission increases<strong style="color:#ffffff; font-size:18px;">from 280 to 340 </strong></p><p style="color:#00FFFE; font-size:18px;">It is recommended to reduce the NH3 usage <strong style="color:#ffffff; font-size:18px;">from 0.60 to 0.85 </strong></p><p style="color:#00FFFE; font-size:18px;">Predicted Value<strong style="color:#ffffff; font-size:18px;"> (next 4-6 mins) </strong>NOx emission will reduce<strong style="color:#ffffff; font-size:18px;"> from 340 to 280.12</strong></p>',
				"HTMLTemp":'<p style="color:#00FFFE; font-size:18px;">Step 1:</p><p style="color:#00FFFE; font-size:18px;">Step 2:</p>'
